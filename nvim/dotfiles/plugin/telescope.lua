...
vim.keymap.set(
	"n",
	"ge",
	function() telescope_builtin.diagnostics({severity=vim.diagnostic.severity.ERROR, bufnr=0}) end,
	{}
)
vim.keymap.set(
	"n",
	"gE",
	function() telescope_builtin.diagnostics({severity=vim.diagnostic.severity.ERROR}) end,
	{}
)
vim.keymap.set(
	"n",
	"gw",
	function() telescope_builtin.diagnostics({severity=vim.diagnostic.severity.WARN, bufnr=0}) end,
	{}
)
vim.keymap.set(
	"n",
	"gW",
	function() telescope_builtin.diagnostics({severity=vim.diagnostic.severity.WARN}) end,
	{}
)
